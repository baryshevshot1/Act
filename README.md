...
|3|[`docs/ARCHITECTURE.md`](./docs/ARCHITECTURE.md)|16 bounded contexts, 6 готовых Level C, полный стек (Уровень B), RLS Operational Constraints, 16 ADR, Bootstrap, Pilot Этап 0, Migration paths, Risk register. ~2700 строк.|Перед кодом, миграциями БД, выбором паттернов.|
